...
TilemapEditor::TilemapEditor(std::string filename, std::shared_ptr<Window> win) : window(win), currentBrushId(0), filename(filename), tilemapEntity(entt::null) {
...
void TilemapEditor::gui(entt::registry& scene) {
	auto& tilemap = scene.get<Tilemap>(tilemapEntity);
